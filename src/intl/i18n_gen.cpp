...
{ "Time (HH:MM:SS)", "Time (HH:MM:SS)", "Vrijeme (SS:MM:SS)", "Zeit (HH:MM:SS)", "Heure (HH:MM:SS)", "Hora (HH:MM:SS)"}, 
 ...
 { "AP modal instructions", "1. Connect to WiFi: Chronos-AP\n2. Open: http://192.168.4.1 or scan the QR with your phone\n3. Download your files\n\nTap Dismiss to continue using the device.\nTap CLOSE AP to stop the server.", "1. Spojite se na WiFi: Chronos-AP\n2. Otvorite: http://192.168.4.1 ili skenirajte QR kod\n3. Preuzmite datoteke\n\nDodirnite Odbaci za nastavak korištenja uređaja.\nDodirnite ZATVORI AP za zaustavljanje poslužitelja.", "1. Mit WLAN verbinden: Chronos-AP\n2. Öffnen: http://192.168.4.1 oder QR-Code mit dem Smartphone scannen\n3. Dateien herunterladen\n\nAuf Schließen tippen, um das Gerät weiter zu verwenden.\nAuf AP SCHLIESSEN tippen, um den Server zu beenden.", "1. Connectez-vous au WiFi : Chronos-AP\n2. Ouvrez : http://192.168.4.1 ou scannez le QR code avec votre téléphone\n3. Téléchargez vos fichiers\n\nAppuyez sur Ignorer pour continuer à utiliser l'appareil.\nAppuyez sur FERMER AP pour arrêter le serveur.", "1. Conéctese al WiFi: Chronos-AP\n2. Abra: http://192.168.4.1 o escanee el QR con su teléfono\n3. Descargue sus archivos\n\nToque Descartar para seguir usando el dispositivo.\nToque CERRAR AP para detener el servidor." }, 
 { "Dismiss", "Dismiss", "Odbaci", "Ausblenden", "Ignorer", "Descartar" }, 
