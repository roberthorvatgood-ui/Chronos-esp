...
// EXIO mappings for external DI/DO on the panel's CH422G expander
// EXIO indices are the bit number on the CH422G port. Provided by board docs.
#define EXIO_DI0 0 // DI0 mapped to EXIO0
#define EXIO_DI1 5 // DI1 mapped to EXIO5
