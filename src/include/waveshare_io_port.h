...
#define DI0 0                     // Digital Input 0 (expander index)
#define DI0_mask (1ULL<<DI0)      // Mask for Digital Input 0
#define DI1 5                     // Digital Input 1 (expander index)
#define DI1_mask (1ULL<<DI1)      // Mask for Digital Input 1

// Human-friendly Gate mappings for expander inputs (EXIO)
#define PIN_GATE_A_EXP DI0        // Gate A -> EXIO0 (DI0)
#define PIN_GATE_A_mask DI0_mask
#define PIN_GATE_B_EXP DI1        // Gate B -> EXIO5 (DI1)
