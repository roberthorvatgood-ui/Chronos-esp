...
// New IO-expander / gate API (non-blocking, debounced):
// Call once during setup:
bool waveshare_io_init();

// Periodically call from your main loop (very cheap, does nothing if not time yet)
void waveshare_io_sample();

// Query functions: return true when the optical gate is CLOSED (active-LOW)
